...
export interface ApiCategoryChallengeCategoryChallenge
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-challenge.category-challenge'
    >;
  };
}
  ...
  attributes: {
    ...
    rating: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    category_challenges: Schema.Attribute.Relation<
      'manyToMany',
      'api::category-challenge.category-challenge'
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    exampleInput: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 300;
      }>;
    exampleOutput: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 400;
      }>;
    hints: Schema.Attribute.Relation<'oneToMany', 'api::hint.hint'>;
...
export interface ApiContentContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subtopic: Schema.Attribute.Relation<'oneToOne', 'api::subtopic.subtopic'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHintHint extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hint.hint'>;
  };
}
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<['python', 'javascript']> &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::category-challenge.category-challenge': ApiCategoryChallengeCategoryChallenge;
